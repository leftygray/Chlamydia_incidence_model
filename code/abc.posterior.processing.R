...
load("output/theta.post.dat") # set the number here to that of the final output run
...
save(mock.not.m,mock.not.f,mock.test.m,mock.test.f,mock.inc.m,mock.inc.f,mock.incper.m,mock.incper.f,mock.prev.m,mock.prev.f,mock.pos.m,mock.pos.f,theta,file="output/posterior.dat") # save the simplified output in a file called 'posterior.dat'
...
for (i in 1:13) {
cat(signif(mock.incper.m[sort.list(mock.incper.m[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,1])])-0.5))],i,1]*100,2),"% ",signif(mock.incper.m[sort.list(mock.incper.m[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,1])])-(1-0.95)/2))],i,1]*100,2),"-",signif(mock.incper.m[sort.list(mock.incper.m[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,1])])-(1-(1-0.95)/2)))],i,1]*100,2)," \t ",signif(mock.incper.m[sort.list(mock.incper.m[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,3])])-0.5))],i,3]*100,2),"% ",signif(mock.incper.m[sort.list(mock.incper.m[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,3])])-(1-0.95)/2))],i,3]*100,2),"-",signif(mock.incper.m[sort.list(mock.incper.m[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,3])])-(1-(1-0.95)/2)))],i,3]*100,2)," \t ",signif(mock.incper.m[sort.list(mock.incper.m[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,4])])-0.5))],i,4]*100,2),"% ",signif(mock.incper.m[sort.list(mock.incper.m[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,4])])-(1-0.95)/2))],i,4]*100,2),"-",signif(mock.incper.m[sort.list(mock.incper.m[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.m[,i,4])])-(1-(1-0.95)/2)))],i,4]*100,2)," \t ",signif(mock.incper.f[sort.list(mock.incper.f[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,1])])-0.5))],i,1]*100,2),"% ",signif(mock.incper.f[sort.list(mock.incper.f[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,1])])-(1-0.95)/2))],i,1]*100,2),"-",signif(mock.incper.f[sort.list(mock.incper.f[,i,1])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,1])])-(1-(1-0.95)/2)))],i,1]*100,2)," \t ",signif(mock.incper.f[sort.list(mock.incper.f[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,3])])-0.5))],i,3]*100,2),"% ",signif(mock.incper.f[sort.list(mock.incper.f[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,3])])-(1-0.95)/2))],i,3]*100,2),"-",signif(mock.incper.f[sort.list(mock.incper.f[,i,3])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,3])])-(1-(1-0.95)/2)))],i,3]*100,2)," \t ",signif(mock.incper.f[sort.list(mock.incper.f[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,4])])-0.5))],i,4]*100,2),"% ",signif(mock.incper.f[sort.list(mock.incper.f[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,4])])-(1-0.95)/2))],i,4]*100,2),"-",signif(mock.incper.f[sort.list(mock.incper.f[,i,4])[which.min(abs(cumsum(is.weights[sort.list(mock.incper.f[,i,4])])-(1-(1-0.95)/2)))],i,4]*100,2)," \n",sep="")}
