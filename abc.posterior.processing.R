...
outputData <- "2022-09-15 22-15-24"  # User specified date folder
fileNumber <- 71                  # User specified file number
...
# nyears == 13 in old version

mock.not.m <- array(0,c(Nsim,nyears,2))
...
mock.not.f <- array(0,c(Nsim,nyears,2))
...
mock.test.m <- array(0,c(Nsim,nyears,2))
...
mock.test.f <- array(0,c(Nsim,nyears,2))
...
mock.prev.m <- array(0,c(Nsim,nyears,2))
...
mock.prev.f <- array(0,c(Nsim,nyears,2))
...
mock.pos.m <- array(0,c(Nsim,nyears,2))
...
mock.pos.f <- array(0,c(Nsim,nyears,2))
